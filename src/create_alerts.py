...
dbutils.widgets.text("output_catalog", "dev_msdvc_bev_mrv")
...
# Assuming `alert_name_dbu_cost` and `alert_name_cloud_cost` are the alert names created earlier
alert_names = [alert_name_dbu_cost, alert_name_cloud_cost]
# COMMAND ----------
